...
install_xcframework "${PODS_ROOT}/../../add_to_app_flutter_module/.ios/Flutter/engine/Flutter.xcframework" "Flutter" "framework" "ios-arm64_armv7" "ios-arm64_x86_64-simulator"
